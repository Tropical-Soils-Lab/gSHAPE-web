...
.fl-header .main-title { font-size: 44px; font-weight: 800; margin: 0 0 6px 0; }
.fl-header .sub-title { font-size: 19px; opacity: 0.95; margin: 0 0 8px 0; }
.fl-header .tagline { color: #a5d6a7; font-size: 13px; text-transform: uppercase; margin: 0; }
...
/* ─── TABS LAYOUT OVERHAUL ─── */
/* 1. MASTER REGION TABS (Outer Level) */
.stTabs > div > [data-baseweb="tab-list"] {
    display: flex !important;
    width: 100% !important;
    justify-content: center !important;
    border-bottom: 2px solid rgba(150, 150, 150, 0.2) !important;
}

.stTabs > div > [data-baseweb="tab-list"] > [data-baseweb="tab"] {
    flex: 1 !important;
    justify-content: center !important;
...
/* Master Active Tab Underline */
.stTabs > div > [data-baseweb="tab-list"] > [aria-selected="true"] {
...
/* Master Tab Hover */
.stTabs > div > [data-baseweb="tab-list"] > [data-baseweb="tab"]:hover {
    background-color: rgba(26, 150, 65, 0.05) !important;
}

/* 2. SUB-TABS (Inner Level - Single Sample, Batch, How-To) */
/* Reset the inner tabs to left-aligned with no borders */
.stTabs [data-baseweb="tab-panel"] .stTabs > div > [data-baseweb="tab-list"] {
    justify-content: flex-start !important;
    border-bottom: none !important;
    gap: 16px !important;
}

.stTabs [data-baseweb="tab-panel"] .stTabs > div > [data-baseweb="tab-list"] > [data-baseweb="tab"] {
...
.stTabs [data-baseweb="tab-panel"] .stTabs > div > [data-baseweb="tab-list"] > [aria-selected="true"] {
    color: #1a9641 !important;
    border-bottom: none !important;
    background-color: transparent !important;
}
